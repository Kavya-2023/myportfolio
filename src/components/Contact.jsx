...
const Contact = () => {
  const contact_info = [
    { logo: "mail", text: "varanasikavya0@gmail.com" },
    { logo: "logo-whatsapp", text: "6300106993" },
  ];
      ...
      <div className="text-center mt-8">
        ...
        <div className="mt-16 flex md:flex-row flex-col gap-6 max-w-5xl bg-gray-800 md:p-6 p-2 rounded-lg mx-auto">
          <form className="flex flex-col flex-1 gap-5" ref={form} onSubmit={sendEmail}>
            ...
            <textarea placeholder="Your Message" rows={10} name="user_message" required></textarea>
            <input value="Send Message" type="submit" className="btn-primary w-fit" />
          </form>
